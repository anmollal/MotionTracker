...
public class RightThumbActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_right_thumb);
        Button button = (Button) findViewById(R.id.rthumb_btn);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_UP) {
            ...
            File file = new File(this.getExternalFilesDir("SwipeData"), "RightThumbSwipeData.csv");
            try {
                file.createNewFile();
    ...
    private String swipeString(List<ScreenLoc> list) {
        ...
        String str = String.format("%s %s","Right Thumb", Long.toString(endTime - startTime));
